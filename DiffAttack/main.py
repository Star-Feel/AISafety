...
parser.add_argument('--dataset_name', default="cifar", type=str,
                    choices=["imagenet_compatible", "cub_200_2011", "standford_car", "cifar"],
...
if __name__ == "__main__":
    ...
    with open(label_path, "r") as f:
        ...
        for i in f.readlines():
            label.append(int(i.split(' ')[1].rstrip()))  # The label number of the imagenet-compatible dataset starts from 1.
